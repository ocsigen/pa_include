...
(* OASIS_START *)
(* DO NOT EDIT (digest: 459b74d29f4981999808d81f780ae68a) *)
(*
...
(* # 22 "src/oasis/OASISFeatures.ml" *)
  ...
  let dyncomp =
    create "dyncomp" alpha
      (fun () ->
         s_ "It compiles the setup.ml while using '-setup-update dynamic'.")
end
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Gregoire Henry"];
          homepage = None;
          synopsis = "Include .mli as module signature.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.3";
     oasis_digest = Some "\238/\152\023L\023\004\244\172:b;G\157ac";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
